...
const data = [
  {
    ...
    image: "/images/projects/zibara.png",
    date: "2020-04-20",
  ...
  },
  {
    title: "Huddle",
    subtitle: "Fintech",
    link: "https://huddle-chris.vercel.app",
    image: "/images/projects/huddle.png",
    date: "2022-05-20",
    desc: "showcasing the groundbreaking fintech startup 'Huddle.' Crafted using React-TS for a robust frontend and ExpressJS and NodeJS for a dynamic backend, this project redefines financial interactions. Harnessing the power of MongoDB for data management, Vite for lightning-fast performance, and SCSS and CSS for stunning visuals, Huddle exemplifies innovation. Explore secure user authentication, real-time transaction tracking, and responsive design. With Huddle, I've woven together technology and finance for a revolutionary user experience.",
  },
  {
    title: "Primar Dashboard",
    subtitle: "A store management dashboard.",
    image: "/images/projects/primar.png",
    date: "2023-06-28",
  ...
  {
    title: "Fiddle (in progress)",
    subtitle: "A gaming site.",
    image: "/images/projects/fiddle.png",
    date: "2023-06-28",
    desc: "Step into the dynamic realm of Fiddle, an exhilarating gaming site that harmonizes React with TypeScript, ExpressJS, NodeJS, MongoDB, Vite, SCSS, and CSS to craft an exceptional platform. Discover the excitement of strategic betting as players wager from their digital wallets, engaging in thrilling competitions against fellow aficionados for enticing stakes. Experience the vitality of real-time interactions, facilitated by React and TypeScript's lively frontend. The backend, driven by ExpressJS and NodeJS, guarantees secure transactions and uninterrupted gameplay. MongoDB ensures robust data management, while Vite optimizes performance. Crafted with SCSS and CSS, the site offers an engaging user interface that promises a visually captivating experience. Get prepared to embark on a unique gaming adventure within the vibrant world of Fiddle.",
  },
];
